...
public class Networking extends
    ...
    public Networking(String urlString, String paramsData, ResultHandler resultHandler) {
    ...
    public String performPostCall(String requestURL,
        ...
        JentisLogger.getLogger(TAG).info("[Jentis] response: " + response);
