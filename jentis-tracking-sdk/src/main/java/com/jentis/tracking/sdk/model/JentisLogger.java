...
public class JentisLogger {
    ...
    private JentisLogger(Class clazz, boolean useSimpleName) {
    ...
    private JentisLogger(String tag) {
        this.tag = tag;
        this.prefixMsg = "";
    }

    private JentisLogger(Class clazz, String tag) {
        this.tag = tag;
        this.prefixMsg = getPrefixMessage(clazz.getName());
    }
     ...
     * @return Logger implementation object
     */
    public static JentisLogger getLogger(Class clazz) {
        return new JentisLogger(clazz, false);
    }
     ...
     * @return Logger implementation object
     */
    public static JentisLogger getLogger(Class clazz, boolean useSimpleName) {
        return new JentisLogger(clazz, useSimpleName);
    }
     ...
     * @return Logger implementation object
     */
    public static JentisLogger getLogger(String tag) {
        return new JentisLogger(tag);
    }
     ...
     * @return Logger implementation object
     */
    public static JentisLogger getLogger(Class clazz, String tag) {
        return new JentisLogger(clazz, tag);
    }
    ...
    public static void disableLogging(boolean value) {
        JentisLogger.logDisabled = value;
    }
